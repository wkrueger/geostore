...
export class Migration20200308175223 extends Migration {
  // prettier-ignore
  async up(): Promise<void> {
    ...
    this.addSql('alter table "mapfile_layer" add constraint "mapfile_layer_mapfile_id_foreign" foreign key ("mapfile_id") references "mapfile" ("id") on update cascade;');
